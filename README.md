...
> When you open the Google Developer Console, you will see what looks like HTML.  There are head tags, body tags, divs, etc.  Now from inside the developer console, click on the element that says body, and then press the delete button on your keyboard.  (Don't worry, you can refresh the page to get the content back.) You should see webpage turn white.
